    ...
    class ModelExtensionModuleIeProCategories extends ModelExtensionModuleIePro {
        ...
        function get_columns_formatted($multilanguage) {
            $columns = array(
                ...
                'Layout' => array('multistore' => true, 'hidden_fields' => array('table' => 'category_to_layout', 'field' => 'layout_id')),
        ...
        function pre_import($data_file)
        {
            ...
            $this->all_filters_simple = $this->model_extension_module_ie_pro_filters->get_all_filters_import_format(false);
        ...
        public function create_categores_from_product($file_data) {
            ...
            if($this->cat_tree) {
                ...
                $all_categories = $this->get_all_categories_import_format();
                    ...
                    if(!empty($cat_data)) {
                        for ($i = 1; $i <= $cat_number; $i++) {
                            ...
                            if (!$cat_found && $some_cat_with_name) {
                                ...
                                $previous_parent_id = $this->create_simple_category($cat_data_temp);
                                $cats_created++;
                                $this->update_process(sprintf($this->language->get('progress_import_categories_from_product_created'), $cats_created), true);
                                $all_categories = $this->get_all_categories_import_format();
                            }
        ...
        public function create_simple_category($cat_data) {
