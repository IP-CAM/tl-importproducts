...
$_['export_import_profile_input_from'] = 'From';
$_['export_import_profile_input_from_help'] = 'Leave blank to remove "from" range';
$_['export_import_profile_input_to'] = 'To';
...
$_['progress_import_from_product_creating_options_error_empty_main_field'] = '<b>Error:</b>  no se encontro el identificador de producto  "<b>%s</b>" en tu archivo.
Si desea utilizar opciones de producto, habilite el  identificador de producto en tu configuración de perfil.
De lo contrario, deshabilite las columnas de opciones "<b>Option XXXX</b>".';
