    ...
    class ModelExtensionModuleIeProOptionValues extends ModelExtensionModuleIePro {
        ...
        function get_columns_formatted($multilanguage) {
            $columns = array(
                ...
                'Option id' => array('hidden_fields' => array('table' => 'option_value', 'field' => 'option_id')),
        ...
        function get_all_option_values_export_format() {
        ...
        function get_all_option_values_import_format() {
        ...
        function create_option_values_from_product($data_file) {
            ...
            foreach ($data_file as $row_number => $data) {
                ...
                if(!empty($option_values)) {
                    ...
                    $option_value_found =  $option_no_values ? true : $option_value_found;
